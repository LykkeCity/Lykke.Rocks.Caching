...
namespace Rocks.Caching.Tests.GetWithLock
{
    ...
    public class GetAsyncTests
    {
        ...
        {
            MultiThreadWithConcurency_InvokesGetValueFunctionOnce_Test (2);
        }
        ...
        {
            MultiThreadWithConcurency_InvokesGetValueFunctionOnce_Test (5);
        }
        ...
        private static void MultiThreadWithConcurency_InvokesGetValueFunctionOnce_Test (int maxThreads)
        {
            // arrange
            var cache = new CacheProviderStub ();
            var cache_key = Guid.NewGuid ().ToString ();
